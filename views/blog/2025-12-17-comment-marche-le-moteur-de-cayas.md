---
title: "On vous ouvre le capot : comment marche le modèle de Cayas ?"
slug: comment-marche-le-modele-de-cayas
date: 2025-12-17
...
Avec [l’outil Plan de vie](https://app.cayas.fr/tools/life-plan) :
...
# Comment le modèle de Cayas calcule-t-il cette allocation optimisée ?

En d'autres termes, qu’y a-t-il sous le capot ?
...
# Le modèle de Cayas et la fonction de valeur
